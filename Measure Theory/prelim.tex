...
\begin{definition}
	...
	\begin{enumerate}
	\item $\mu(\emptyset) = 0$
	\item $\mu(\cup_{n = 1}^{\infty} \mathcal{A}_n) = \sum_{n = 1}^{\infty} \mu(\mathcal{A}_n)$ for any family of disjoint sets $\{A_n\} \subset \mathcal{A}$
\end{enumerate}
\end{definition}

We deem the tuple $(X,\mathcal{A},\mu)$ of a set $X$ and a $\sigma$-algebra $\mathcal{A}$ on it endowed with the function above as a measure space.
...
$$ \mu^*(E) = \inf\{\sum_{n \in I} \mu(A_i)  : \{{A_i}\}_{I} \subseteq \mathcal{A}, B \subseteq \bigcup_{i \in I} A_i, I \subseteq \mathbb{N} \}$$ 
...
\begin{theorem}
\label{outermspace}
 Let $\mu^*$ be an outer measure on $X$, and let $\mathcal{M}_{\mu^*}$ be the set of all $\mu^*$-measurable sets. Then, $\mu^*$ is a measure on $\mathcal{M}_{\mu^*}$.
\end{theorem}
\begin{proof}
The proof follows from directly from Theorem $\ref{cath}$.
\end{proof}
